...
public class BallController implements Runnable {
    ...
    public void moveUp(int n)
    {
        synchronized(writer){
            ...
            if(writer != null){
                try{
                    writer.writeObject(new Info(ball.getX(), ball.getY(), type));
                }catch(Exception e){
    ...
    public void moveRight(int n){
        synchronized(writer){
            ...
            if((writer != null)){
                try{
                    writer.writeObject(new Info(ball.getX(), ball.getY(), type, scored));
                    scored = 0;
                }catch(Exception e){
    ...
    public void startRound(){
        if(!on_round){
            ...
            if(score.game_ended){
                ...
                synchronized(writer){
                    try {
                        writer.writeObject(new Info(ball.getX(), ball.getY(), 0, 3));
